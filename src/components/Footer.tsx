        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <a href="https://padespace.io/privacy-policy" className="hover:text-primary transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="https://padespace.io/terms-of-service/" className="hover:text-primary transition-colors">
                  Terms of Service
                </a>
              </li>
            </ul>
